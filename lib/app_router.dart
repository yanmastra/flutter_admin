...
import 'package:flutter_admin/views/screens/buttons_screen.dart';
import 'package:flutter_admin/views/screens/colors_screen.dart';
import 'package:flutter_admin/views/screens/crud_detail_screen.dart';
import 'package:flutter_admin/views/screens/crud_screen.dart';
import 'package:flutter_admin/views/screens/dashboard_screen.dart';
import 'package:flutter_admin/views/screens/dialogs_screen.dart';
import 'package:flutter_admin/views/screens/error_screen.dart';
import 'package:flutter_admin/views/screens/form_screen.dart';
import 'package:flutter_admin/views/screens/general_ui_screen.dart';
import 'package:flutter_admin/views/screens/iframe_demo_screen.dart';
import 'package:flutter_admin/views/screens/login_screen.dart';
import 'package:flutter_admin/views/screens/logout_screen.dart';
import 'package:flutter_admin/views/screens/my_profile_screen.dart';
import 'package:flutter_admin/views/screens/register_screen.dart';
import 'package:flutter_admin/views/screens/text_screen.dart';
    ...
    routes: [
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) {
          return NoTransitionPage<void>(
            key: state.pageKey,
            child: CrudDetailScreen(id: state.pathParameters['id'] ?? ''),
          );
        },
      ),
      GoRoute(
